...
# NOTE: You may need to reboot into recovery mode,
# open the Terminal app, and run `csrutil disable` - to
# disable System Integrity Protection in order to delete
# and recreate the sleepimage file...
#

...
1. I also had to do: `compinit -u` in order to get zplug to work reliably. Note that this probably isn't very secure...also I needed to follow the instructions here: https://evalcode.com/zsh-default-wsl-windows-10/

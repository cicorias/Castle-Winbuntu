...
The friction resulting from such a limited number of comparatively clumsy/imprecise terminal emulation options continues to manifest abrasively over the course of a project's term, resulting in the corrosive atrophy of collaborative speed and diminished iterative improvements. The only expected variation is in its pipeline-damaging potency; which can typically be measured relative to the composition and complexity of the requirements (for instance, golang/node.js-based projects which more typically feature a majority of of collaborators favoring non-Windows platforms wouldn't be expected to suddenly receive a "boon" to productivity by shifting exclusively to a Windows-native development workflow...). By extension, where organizational initiatives may seek to further process-engineer the delivery of better/faster products/services, and align these with objectives related to digital transformation starting with a cursory "bottom-up" examination of development workflows would quickly disvover this "irritant" as primarily responsible for continuously "chafing" any reasonable expectation of improved development efficiency.

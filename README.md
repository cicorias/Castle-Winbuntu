...
Presently, I'm also using ConEmu as my terminal application, as it feels most similiar to Iterm2, which I had grown quite fond of (having now tried Hyper.js, wsltty, and a few others, the names of which I'm now forgetting, ConEmu - while not perfect - has been the most stable, configurable, and fully-featured, unique in offering tabbed-sessions, ~which I can't really live without~ which up to this point has been a firm requirement for me, even as I warm slightly to just using tmux to exclusively boundary my sessions ;)
